...
<div class="col-md-12 card p-3 mt-3">
	<header>
		<div class="wljp-cv-heading p-3">
			<span><?php esc_html_e( 'Your CV', EJP_DOMAIN ); ?></span>
		</div>
	</header>
	<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" id="wljp-cv-update-form" class="wljp-cv-update-form">
        ...
        <div class="card p-3 mb-4">
            <div class="wljp-cv-section-heading"><span><?php esc_html_e( 'Personal', EJP_DOMAIN ); ?></span></div>
            <div class="row mt-2">
				<div class="form-group col-sm-6">
					<label for="wljp_employee_personal_name"><?php esc_html_e( 'Name', EJP_DOMAIN ); ?>:</label>
        ...
        <div class="card p-3 mb-4">
            <div class="wljp-cv-section-heading"><span><?php esc_html_e( 'Upload CV', EJP_DOMAIN ); ?></span></div>
        ...
        <div class="card p-3 mb-4">
            <div class="wljp-cv-section-heading"><span><?php esc_html_e( 'Experience', EJP_DOMAIN ); ?></span></div>
            <div class="row mt-2">
				<div class="form-group col-sm-12">
        ...
        <div class="card p-3 mb-4">
            <div class="wljp-cv-section-heading"><span><?php esc_html_e( 'Employment', EJP_DOMAIN ); ?></span></div>
			...
			<button type="button" id="wljp_employee_employment_row_add_more" class="wljp_row_add_more btn btn-sm"><?php esc_html_e( 'Add more', EJP_DOMAIN ); ?></button>
		</div>

        <div class="card p-3 mb-4">
            <div class="wljp-cv-section-heading"><span><?php esc_html_e( 'Education', EJP_DOMAIN ); ?></span></div>
			<div id="wljp_employee_education_rows">
				...
				<div class="row wljp_employee_education_row mt-3">
					...
					<div class="col-sm-6 mt-2">
						...
						<input type="text" name="employee_education_year_of_passing[]" class="w-100 d-block col" placeholder="<?php esc_attr_e( 'Format: XXXX', EJP_DOMAIN ); ?>" value="<?php echo esc_attr($year_of_passing); ?>">
					</div>
				</div>
					<?php endforeach;
				else : ?>
				<div class="row wljp_employee_education_row mt-3">
					...
					<div class="col-sm-6 mt-2">
						<label><?php esc_html_e( 'Year of Passing', EJP_DOMAIN ); ?>:</label>
						<input type="text" name="employee_education_year_of_passing[]" class="w-100 d-block col" placeholder="<?php esc_attr_e( 'Format: XXXX', EJP_DOMAIN ); ?>">
					</div>
				</div>
				<?php endif; ?>
			</div>
			<button type="button" id="wljp_employee_education_row_add_more" class="wljp_row_add_more btn btn-sm"><?php esc_html_e( 'Add more', EJP_DOMAIN ); ?></button>
		</div>

        <div class="card p-3 mb-4">
            <div class="wljp-cv-section-heading"><span><?php esc_html_e( 'Skills', EJP_DOMAIN ); ?></span></div>
			...
			<button type="button" id="wljp_employee_skills_row_add_more" class="wljp_row_add_more btn btn-sm"><?php esc_html_e( 'Add more', EJP_DOMAIN ); ?></button>
		</div>

        <div class="card p-3 mb-4">
            <div class="wljp-cv-section-heading"><span><?php esc_html_e( 'Certification', EJP_DOMAIN ); ?></span></div>
			<div id="wljp_employee_certification_rows">
				...
				<div class="row wljp_employee_certification_row">
					...
					<div class="col-sm-4 mt-2">
						...
						<input type="number" step="1" name="employee_certification_year[]" class="w-100 d-block col" placeholder="<?php esc_attr_e( 'Format: XXXX', EJP_DOMAIN ); ?>" value="<?php echo esc_attr( $year_of_certification ); ?>">
					</div>
				</div>
					<?php endforeach;
				else : ?>
				<div class="row wljp_employee_certification_row">
					...
					<div class="col-sm-4 mt-2">
						<label><?php esc_html_e( 'Year of Certification', EJP_DOMAIN ); ?>:</label>
						<input type="number" step="1" name="employee_certification_year[]" class="w-100 d-block col" placeholder="<?php esc_attr_e( 'Format: XXXX', EJP_DOMAIN ); ?>">
					</div>
				</div>
				<?php endif; ?>
			</div>
			<button type="button" id="wljp_employee_certification_row_add_more" class="wljp_row_add_more btn btn-sm"><?php esc_html_e( 'Add more', EJP_DOMAIN ); ?></button>
		</div>

        <div class="card p-3 mb-4">
            <div class="wljp-cv-section-heading"><span><?php esc_html_e( 'Desired Job Details', EJP_DOMAIN ); ?></span></div>
			<div class="row">
				<div class="col-sm-12 mt-2">
					<label for="wljp_employee_desired_job_locations"><?php esc_html_e( 'Job Locations', EJP_DOMAIN ); ?>:</label>
					<input type="text" name="employee_desired_job_locations" id="wljp_employee_desired_job_locations" class="w-100 d-block col" value="<?php echo esc_attr( $locations_string ); ?>" placeholder="<?php esc_attr_e( 'Separated by comma', EJP_DOMAIN ); ?>">
				</div>
				<div class="col-sm-6 mt-2">
					<label for="wljp_employee_desired_job_industry"><?php esc_html_e( 'Industry', EJP_DOMAIN ); ?>:</label>
				...
				<div class="col-sm-6 mt-2">
					...
					<select data-placeholder="<?php esc_attr_e( 'Select departments', EJP_DOMAIN ); ?>" name="employee_desired_job_departments[]" id="wljp_employee_desired_job_departments" class="w-100 d-block col" multiple>
				...
				<div class="col-sm-6 mt-2">
					...
					<select data-placeholder="<?php esc_attr_e( 'Select job types', EJP_DOMAIN ); ?>" name="employee_desired_job_types[]" id="wljp_employee_desired_job_types" class="w-100 d-block col" multiple>
		...
		<div class="float-right wljp-cv-submit-block">
			<button type="submit" class="wljp-cv-update-submit"><?php esc_html_e( 'Update CV', EJP_DOMAIN ); ?></button>
		</div>
	</form>
	<div class="float-left">
		<a href="javascript:void(0)" class="wljp-cv-more-options"><?php esc_html_e( 'More Options', EJP_DOMAIN ); ?></a>
		<div class="mt-2 wljp-cv-delete">
        	<button type="button" id="wljp-cv-delete-button" class="btn btn-danger" data-message="<?php esc_attr_e( 'Are you sure to delete your CV? All of your job applications will also be removed.', EJP_DOMAIN ); ?>"><?php esc_html_e( 'Delete CV', EJP_DOMAIN ); ?></button>
		</div>
	</div>
</div>
<?php else : ?>
<div class="col-sm-12 col-md-12 card p-3 mt-3">
	<header>
		<div class="wljp-cv-heading p-3">
			<span><?php esc_html_e( 'Register your CV', EJP_DOMAIN ); ?></span>
		</div>
	</header>
	<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" id="wljp-cv-form" class="wljp-cv-form">
        ...
        <div class="card p-3 mb-4">
			...
			<div class="row">
				<div class="col-sm-12 mt-2">
					<label for="wljp_employee_desired_job_locations"><?php esc_html_e( 'Job Locations', EJP_DOMAIN ); ?>:</label>
					<input type="text" name="employee_desired_job_locations" id="wljp_employee_desired_job_locations" class="w-100 d-block col" placeholder="<?php esc_attr_e( 'Separated by comma', EJP_DOMAIN ); ?>">
				</div>
		...
		<div class="float-right wljp-cv-submit-block">
			<button type="submit" class="wljp-cv-submit"><?php esc_html_e( 'Register CV', EJP_DOMAIN ); ?></button>
		</div>
	</form>
</div>
<?php endif; ?>
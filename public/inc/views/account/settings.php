...
<div class="col-sm-12 col-md-12 card p-3 mt-3">
	...
	<div class="wljp-account-heading mt-0 mb-0">
		<span><?php esc_html_e( 'Account Settings', EJP_DOMAIN ); ?></span>
	</div>
	...
	<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" id="wljp-account-form" class="wljp-account-form">
		...
		<div class="form-group mt-3">
			<label><?php esc_html_e( 'Username', EJP_DOMAIN ); ?></label><br>
			<span><?php echo esc_html( $account_username ); ?></span>
			<a href="javascript:void(0)" id="wljp-change-password-email-button" class="ml-2"><?php esc_html_e( 'Change Password', EJP_DOMAIN ); ?></a>
		</div>

		<div class="wljp-change-password-email">
			<div class="form-group">
				<label for="wljp-account-email"><?php esc_html_e( 'Email Address', EJP_DOMAIN ); ?></label><br>
			...
			<div class="form-group">
				<label for="wljp-account-confirm-password"><?php esc_html_e( 'Confirm Password', EJP_DOMAIN ); ?></label>
			...
			<div class="float-right wljp-account-submit-block">
				<button type="submit" class="wljp-account-submit"><?php esc_html_e( 'Update', EJP_DOMAIN ); ?></button>
			</div>
		</div>
	</form>
</div>
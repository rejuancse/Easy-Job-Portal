...
class WL_JP_Employee_Front {
	...
	public static function register_cv() {
		...
		update_post_meta( $post_id, 'wljp_candidate_document', $document );
	...
	public static function update_cv() {
		...
		$saved_document       = get_post_meta( $candidate->ID, 'wljp_candidate_document', true );
	...
	public static function delete_cv() {
		...
		$document    = get_post_meta( $cv->ID, 'wljp_candidate_document', true );

<?php
/**
 * File containing the class Easy_Job_Portal_Email_Admin_Updated_Job.
 *
 ...
 */
class Easy_Job_Portal_Email_Admin_Updated_Job extends Easy_Job_Portal_Email_Template {
	/**
	...
	public static function get_name() {
		return __( 'Admin Notice of Updated Listing', 'easy-job-portal' );
	}
	...
	public static function get_description() {
		return __( 'Send a notice to the site administrator when a job is updated on the frontend.', 'easy-job-portal' );
	}
	...
	public function get_subject() {
		...
		return sprintf( __( 'Job Listing Updated: %s', 'easy-job-portal' ), $job->post_title );
	}

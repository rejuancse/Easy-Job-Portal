<?php
/**
 * File containing the class Easy_Job_Portal_Email_Template.
 *
...
/**
 * Class Easy_Job_Portal_Email_Template
 */
abstract class Easy_Job_Portal_Email_Template extends Easy_Job_Portal_Email {
	/**
	...
	/**
	 * Get the default template path that Easy Job Portal should look for the templates.
	 *
	 * @type abstract
	 * @return string
	 */
	...
	protected function locate_template( $plain_text ) {
		...
		return locate_easy_job_portal_template( $this->get_template_file_name( $plain_text ), $template_path, $template_default_path );
	}

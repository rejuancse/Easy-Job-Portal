<?php
/**
 * File containing the class Easy_Job_Portal_Taxonomy_Meta.
 *
 ...
 * @since 1.28.0
 */
class Easy_Job_Portal_Taxonomy_Meta {
	/**
	...
	/**
	 * Easy_Job_Portal_Taxonomy_Meta constructor.
	 */
	...
	public function display_schema_org_employment_type_field( $term, $taxonomy ) {
		...
		if ( ! empty( $employment_types ) ) {
			...
			<th scope="row"><label for="feature-group"><?php esc_html_e( 'Employment Type', 'easy-job-portal' ); ?></label></th>
	...
	public function add_form_display_schema_org_employment_type_field( $taxonomy ) {
		...
		if ( ! empty( $employment_types ) ) {
			...
			<label for="feature-group"><?php esc_html_e( 'Employment Type', 'easy-job-portal' ); ?></label>
	...
	public function add_employment_type_column( $columns ) {
		$columns['employment_type'] = __( 'Employment Type', 'easy-job-portal' );
		return $columns;
	}
...
Easy_Job_Portal_Taxonomy_Meta::instance();

<?php
/**
 * File containing the class Easy_Job_Portal_Cache_Helper.
 *
 ...
 * @since 1.0.0
 */
class Easy_Job_Portal_Cache_Helper {
	...
	public static function init() {
		...
		add_action( 'easy_job_portal_my_job_do_action', [ __CLASS__, 'easy_job_portal_my_job_do_action' ] );
	 ...
	 * @param string $action
	 */
	public static function easy_job_portal_my_job_do_action( $action ) {
...
Easy_Job_Portal_Cache_Helper::init();

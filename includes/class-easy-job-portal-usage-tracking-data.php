<?php
/**
 * File containing the class Easy_Job_Portal_Usage_Tracking_Data.
 *
 ...
 * @since 1.30.0
 */
class Easy_Job_Portal_Usage_Tracking_Data {
	/**
	...
	public static function get_event_logging_base_fields() {
		...
		return apply_filters( 'easy_job_portal_event_logging_base_fields', $base_fields );
	}
}

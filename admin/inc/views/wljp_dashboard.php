...
<div class="wljp">
	<div class="container-fluid">
		<div class="row">
			<div class="col">
				<h1 class="display-4 text-center bg-primary text-white pt-1 pb-3 mt-2"><span class="border-bottom"><i class="fa fa-tachometer"></i> <?php esc_html_e( 'Job Portal Dashboard', EJP_DOMAIN ); ?></span></h1>
				<div class="mt-3 alert alert-secondary text-center" role="alert">
					<?php esc_html_e( "Here, you can view job portal stats.", EJP_DOMAIN ); ?>
				</div>
			</div>
		</div>
            	...
            	<div class="wljp-stats-item">
            		<div class="row d-flex h-100 ">
            			...
            			<div class="col-8 justify-content-center align-self-center text-right">
            				...
            				<div class="wljp-stats-title"><a href="<?php echo admin_url( 'edit.php?post_type=job_listing' ); ?>" class="wljp-stats-item-link"><?php esc_html_e( 'Jobs Published', EJP_DOMAIN ); ?></a></div>
            			</div>
            		</div>
            	</div>
            </div>
            	...
            	<div class="wljp-stats-item">
            		<div class="row d-flex h-100">
            			...
            			<div class="col-8 justify-content-center align-self-center text-right">
            				...
            				<div class="wljp-stats-title"><a href="<?php echo admin_url( 'edit-tags.php?taxonomy=industry&post_type=job_listing' ); ?>" class="wljp-stats-item-link"><?php esc_html_e( 'Industries', EJP_DOMAIN ); ?></a></div>
            			</div>
            		</div>
            	</div>
            </div>
            	...
            	<div class="wljp-stats-item">
            		<div class="row d-flex h-100">
            			...
            			<div class="col-8 justify-content-center align-self-center text-right">
            				...
            				<div class="wljp-stats-title"><a href="<?php echo admin_url( 'edit-tags.php?taxonomy=department&post_type=job_listing' ); ?>" class="wljp-stats-item-link"><?php esc_html_e( 'Departments', EJP_DOMAIN ); ?></a></div>
            			</div>
            		</div>
            	</div>
            </div>
            	...
            	<div class="wljp-stats-item">
            		<div class="row d-flex h-100">
            			...
            			<div class="col-8 justify-content-center align-self-center text-right">
            				...
            				<div class="wljp-stats-title"><a href="<?php echo admin_url( 'edit-tags.php?taxonomy=skill&post_type=job_listing' ); ?>" class="wljp-stats-item-link"><?php esc_html_e( 'Skills', EJP_DOMAIN ); ?></a></div>
            			</div>
            		</div>
            	</div>
            </div>
            	...
            	<div class="wljp-stats-item">
            		<div class="row d-flex h-100">
            			...
            			<div class="col-8 justify-content-center align-self-center text-right">
            				...
            				<div class="wljp-stats-title"><a href="<?php echo admin_url( 'edit-tags.php?taxonomy=job_location&post_type=job_listing' ); ?>" class="wljp-stats-item-link"><?php esc_html_e( 'Job Locations', EJP_DOMAIN ); ?></a></div>
            			</div>
            		</div>
            	</div>
            </div>
            	...
            	<div class="wljp-stats-item">
            		<div class="row d-flex h-100">
            			...
            			<div class="col-8 justify-content-center align-self-center text-right">
            				...
            				<div class="wljp-stats-title"><a href="<?php echo admin_url( 'edit.php?post_type=employee' ); ?>" class="wljp-stats-item-link"><?php esc_html_e( 'Employees', EJP_DOMAIN ); ?></a></div>
            			</div>
            		</div>
            	</div>
            </div>
            	...
            	<div class="wljp-stats-item">
            		<div class="row d-flex h-100">
            			...
            			<div class="col-8 justify-content-center align-self-center text-right">
            				...
            				<div class="wljp-stats-title"><a href="<?php menu_page_url( 'job_applications', true ); ?>" class="wljp-stats-item-link"><?php esc_html_e( 'Job Applications', EJP_DOMAIN ); ?></a></div>
            			</div>
            		</div>
            	</div>
            </div>
		...
		<div class="row">
			<div class="col">
				<div class="text-center wljp-recent-activities-heading"><?php esc_html_e( "Recent Activities", EJP_DOMAIN ); ?></div>
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-12 mb-4">
						<?php if ( count( $recent_jobs ) ) { ?>
						<div class="wljp-recent-list-title"><?php esc_html_e( "Last 10 Jobs Published", EJP_DOMAIN ); ?><span class="float-right"><i class="fa fa-bullhorn"></i></span></div>
						...
						<?php } else { ?>
							<div class="alert alert-secondary"><?php esc_html_e( "There is no recent job.", EJP_DOMAIN ); ?></div>
						<?php } ?>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12 mb-4">
						<?php if ( count( $recent_employees ) ) { ?>
						<div class="wljp-recent-list-title"><?php esc_html_e( "Last 10 Employee Registrations", EJP_DOMAIN ); ?><span class="float-right"><i class="fa fa-users"></i></span></div>
						<ul class="list-group wljp-recent-list">
						...
						<?php } else { ?>
							<div class="alert alert-secondary"><?php esc_html_e( "There is no recent employee registration.", EJP_DOMAIN ); ?></div>
						<?php } ?>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12 mb-4">
						<?php if ( count( $recent_applications ) ) { ?>
						<div class="wljp-recent-list-title"><?php esc_html_e( "Last 10 Job Applications", EJP_DOMAIN ); ?><span class="float-right"><i class="fa fa-envelope-open"></i></span></div>
						<ul class="list-group wljp-recent-list">
							...
							?>
							<li class="list-group-item">
								<span class="wljp-recent-item-left"><?php echo wp_kses_post( $employee_link ); ?>&nbsp;<?php esc_html_e( "applied to", EJP_DOMAIN ); ?>&nbsp;<?php echo wp_kses_post($job_link); ?></span>
								<span class="wljp-recent-item-right float-right"><?php echo esc_html($date); ?></span>
							</li>
							<?php } ?>
						</ul>
						<?php } else { ?>
							<div class="alert alert-secondary"><?php esc_html_e( "There is no recent job application.", EJP_DOMAIN ); ?></div>
						<?php } ?>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12 mb-4">
						<div class="wljp-recent-list-title bg-primary text-white">
							<?php esc_html_e( "Jobs Portal Pro Features", EJP_DOMAIN ); ?>
							<span class="float-right"><i class="fa fa-star"></i></span>
						</div>
						<ul class="list-group list-group-flush wljp-recent-list">
							<li class="list-group-item">
								<div class="alert alert-primary">
									<h6><i class="fa fa-check"></i>&nbsp;&nbsp;<?php esc_html_e( "Signup as Recruiter", EJP_DOMAIN ); ?></h6>
								</div>
								<div class="alert alert-warning">
									<h6><i class="fa fa-check"></i>&nbsp;&nbsp;<?php esc_html_e( "Separate Recruiter Dashboard", EJP_DOMAIN ); ?></h6>
								</div>
								<div class="alert alert-info">
									<h6><i class="fa fa-check"></i>&nbsp;&nbsp;<?php esc_html_e( "Unlimited Recruiters", EJP_DOMAIN ); ?></h6>
								</div>
								<div class="alert alert-success">
									<h6><i class="fa fa-check"></i>&nbsp;&nbsp;<?php esc_html_e( "Recruiter's Account Approval", EJP_DOMAIN ); ?></h6>
								</div>
								<div class="row mt-2">
									<div class="col">
										<a href="http://demo.weblizar.com/jobs-portal-pro/" class="btn btn-block btn-info" target="_blank"><?php esc_html_e( "Try Pro", EJP_DOMAIN ); ?></a>
									</div>
									<div class="col">
										<a href="https://weblizar.com/plugins/jobs-portal-pro/" class="btn btn-block btn-success" target="_blank"><?php esc_html_e( "Buy Pro", EJP_DOMAIN ); ?></a>
									</div>
								</div>
							</li>
						</ul>

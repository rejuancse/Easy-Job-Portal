			...
			<div class="col">
				<h1 class="display-4 text-center" style="font-size: 36px; margin-top: 30px">
					<span class="border-bottom">
						 <?php esc_html_e( 'Job Applications', DJP_DOMAIN ); ?>
					</span>
				</h1>

				<div class="mt-3 alert alert-secondary text-center" role="alert">
					<?php esc_html_e( "Here, you can view job applications.", DJP_DOMAIN ); ?>
				</div>
			</div>
		</div>
			...
			<div class="col-sm-6">
				<form method="GET" action="">
					...
					foreach( $_GET as $name => $value ) {
						...
						<input type="text" name="search" class="wljp-search-job-input w-100 d-block col" placeholder="<?php esc_attr_e( "Search job title, employee name", DJP_DOMAIN ); ?>">
				...
				<div class="wljp-search-info text-center mb-3">
					...
					<span><a class="" href="<?php menu_page_url( 'job_applications', true ); ?>"><?php esc_html_e( "Clear filter", DJP_DOMAIN ); ?></a></span>
				</div>
				<?php
				endif; ?>
			</div>
				...
				<table class="table table-hover" id="wljp-job-application-table">
					<thead>
						<tr>
							...
							<th scope="col"><?php esc_html_e( 'Employee', DJP_DOMAIN ); ?></th>

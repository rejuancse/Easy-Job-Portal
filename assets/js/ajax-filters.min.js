jQuery(document).ready(function(e) {
    function t(t) {
        return !!n() && (!e(document.body).hasClass("disable-easy-job-portal-form-state-storage") && !t.data("disable-form-state-storage"))
    }
    ...
    function g(t, n, i) {
        ...
        return n.showing_all ? o.addClass("easy-job-portal-showing-all") : o.removeClass("easy-job-portal-showing-all"), n.html && (i ? a.append(n.html) : a.html(n.html)), !0 === t.data("show_pagination") ? (t.find(".easy-job-portal-pagination").remove(), n.pagination && t.append(n.pagination)) : (!n.found_jobs || n.max_num_pages <= n.data.page ? e(".load_more_jobs:not(.load_previous)", t).hide() : e(".load_more_jobs", t).show(), e(".load_more_jobs", t).removeClass("loading").data("page", n.data.page), e("li.job_listing", a).css("visibility", "visible")), !0
    }
    var _ = "job_listing_";
    ...
    if (e("div.job_listings").on("click", "li.job_listing a", function() {
        ...
        }).on("click", ".easy-job-portal-pagination a", function() {
            ...
            if (!(y < 0)) {
                if (d(c), f[y] && f[y].abort(), i && 1 !== n || (e("li.job_listing, li.no_job_listings_found", _).css("visibility", "hidden"), _.addClass("loading")), c.find(".load_more_jobs").data("page", n), !0 === c.data("show_filters")) {
                    ...
                    S.val() !== S.attr("placeholder") && (o = S.val()), x.val() !== x.attr("placeholder") && (r = x.val()), s = {
                        lang: easy_job_portal_ajax_filters.lang,
                        search_keywords: o,
                        search_location: r,
                        search_categories: a,
                        filter_job_type: k,
                ...
                f[y] = e.ajax({
                    type: "POST",
                    url: easy_job_portal_ajax_filters.ajax_url.toString().replace("%%endpoint%%", "get_listings"),
                    data: s,
                    success: function(e) {
                        if (e) try {
        ...
        }), e("#search_keywords, #search_location, .job_types :input, #search_categories, .easy-job-portal-filter").change(function() {
            var t = e(this).closest("div.job_listings");
        ...
        }), e.isFunction(e.fn.select2) && "undefined" != typeof easy_job_portal_select2_args) {
        var p = easy_job_portal_select2_args;
